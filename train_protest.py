...
from tools.extend.util import ProtestDataset, paddle_infer_args, protest_train_parser
from tools.extend.model import modified_resnet50, AverageMeter, Lighting
...
def main(args):
    global best_loss
    #config_detrec = args["paddle"]
    #args = args["protest_train"]
    loss_history_train = []
    loss_history_val = []
    ...
    # other model
    model = build_model_extend("JointVisDet", args)
...
if __name__ == "__main__":
    ...
    paddle_infer_args(parser)
    protest_train_parser(parser)
